...
set leffile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130B/libs.ref/sky130_fd_sc_hd/lef/sky130_fd_sc_hd.lef

# The SPICE netlist containing subcell definitions for all the standard cells
set spicefile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130B/libs.ref/sky130_fd_sc_hd/spice/sky130_fd_sc_hd.spice

# The liberty format file containing standard cell timing and function information
set libertyfile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130B/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ff_n40C_1v95.lib
...
set techleffile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130B/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd__nom.tlef
...
set gdsfile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130B/libs.ref/sky130_fd_sc_hd/gds/sky130_fd_sc_hd.gds	;# GDS database of standard cells
set verilogfile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130B/libs.ref/sky130_fd_sc_hd/verilog/sky130_fd_sc_hd.v	;# Verilog models of standard cells
