...
set leffile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.ref/sky130_osu_sc_15t_ms/lef/sky130_osu_sc_15t_ms.lef

# The SPICE netlist containing subcell definitions for all the standard cells
set spicefile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.ref/sky130_osu_sc_15t_ms/spice/sky130_osu_sc_15t_ms.spice

# The liberty format file containing standard cell timing and function information
set libertyfile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.ref/sky130_osu_sc_15t_ms/lib/sky130_osu_sc_15t_ms.lib
...
set techleffile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.ref/sky130_osu_sc_15t_ms/techlef/sky130_osu_sc_15t_ms.tlef
...
set techfile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.tech/magic/sky130A.tech	    ;# magic techfile
set magicrc=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.tech/magic/sky130A.magicrc    ;# magic startup script
set magic_display="XR" 	;# magic display, defeat display query and OGL preference
set netgen_setup=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.tech/netgen/sky130A_setup.tcl	;# netgen setup file for LVS
set gdsfile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.ref/sky130_osu_sc_15t_ms/gds/sky130_osu_sc_15t_ms.gds	;# GDS database of standard cells
set verilogfile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.ref/sky130_osu_sc_15t_ms/verilog/sky130_osu_sc_15t_ms.v	;# Verilog models of standard cells
