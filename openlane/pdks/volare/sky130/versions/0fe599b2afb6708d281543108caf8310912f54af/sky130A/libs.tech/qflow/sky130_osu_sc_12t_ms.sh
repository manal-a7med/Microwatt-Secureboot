...
set leffile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.ref/sky130_osu_sc_12t_ms/lef/sky130_osu_sc_12t_ms.lef

# The SPICE netlist containing subcell definitions for all the standard cells
set spicefile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.ref/sky130_osu_sc_12t_ms/spice/sky130_osu_sc_12t_ms.spice

# The liberty format file containing standard cell timing and function information
set libertyfile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.ref/sky130_osu_sc_12t_ms/lib/sky130_osu_sc_12t_ms.lib
...
set techleffile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.ref/sky130_osu_sc_12t_ms/techlef/sky130_osu_sc_12t_ms.tlef
...
set gdsfile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.ref/sky130_osu_sc_12t_ms/gds/sky130_osu_sc_12t_ms.gds	;# GDS database of standard cells
set verilogfile=${HOME}/.volare/volare/sky130/build/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.ref/sky130_osu_sc_12t_ms/verilog/sky130_osu_sc_12t_ms.v	;# Verilog models of standard cells
